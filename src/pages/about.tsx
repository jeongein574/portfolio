...
export default function About() {
  return (
    <>
      <NextSeo
        title="About Ein Jeong | Software Developer"
        description="Learn more about Ein Jeong, a dedicated Software Developer with 2 years of experience. Discover the journey, skills, and passion that drive me to create innovative and user-friendly web solutions."
        canonical={`${siteMetadata.siteUrl}/about`}
        openGraph={{
          url: `${siteMetadata.siteUrl}/about`,
          title: "Learn About Ein Jeong - Software Developer",
          description:
